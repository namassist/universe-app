...
Spreadsheet movement in and out of the master catalogues and the unit registry:
...
catalogue holds is failed by row number rather than silently creating it, the
atomicity of a commit, and the grants that govern both directions.
