...
export const en: Dict = {
  ...
  flImpRemoveB:
    "This file is a whole day of the yard, so anything it does not name is treated as no longer operating. Check the lists below before pressing Import.",
  flAdd: "Add Fleet",
  flEditT: "Edit Fleet",
  ...
  flErrLeader: "A digger is required and must not lead another fleet.",
