...
export const en: Dict = {
  ...
  dataAsOf: "Data as of",
  statUnfit: "Failed FTW",
  dUnfit1: "verdict or work category —",
  dUnfit2: "replacement needed",
  statAbsent: "Not clocked in",
  dAbsent1: "of",
  dAbsent2: "rostered on this shift",
  ...
  statPresent: "Present this shift",
  statSimperExp: "Expired SIMPERs",
  dSimperSoon: "expiring within 60 days",
  statActualShift: "This shift's ACTUAL",
  dNotGenerated: "not generated yet",
  ...
  chartRatioTitle: "Operator ratio",
  chartSpareTitle: "Spare operators",
  chartRestTitle: "Told to rest (short on sleep)",
  chartEquipmentTitle: "Equipment report",
  chartReady: "Ready to work",
  chartNoFinger: "No fingerprint",
  chartNoFtw: "Failed FTW",
  chartQty: "Equipment",
  chartEqpReady: "Ready",
  chartRunning: "Running",
  chartCategory: "Category",
  chartTotal: "Total",
  chartOperators: "operators",
  chartNoData: "No data for this shift yet.",
  statAllocGap: "Units without an operator",
  dUnits: "units",
  ...
  apTitle: "Allocation Priority",
  apSub: "Which units are crewed first when operators are short.",
  apListTitle: "Priority order",
  apSave: "Save order",
  apSaving: "Saving…",
  apSaved: "Priority order saved.",
  apReset: "Discard",
  ...
  apUp: "Raise priority",
  apDown: "Lower priority",
  apEmpty: "No active units yet",
  apEmptyB: "This list follows the unit master. Add units first.",
  ...
  faCrewTitle: "Today's operators",
  faCrewSub:
    "Every unit with its standing operators, plus the spares — with today's roster. Roster for",
  faCrewIdle: "units with nobody on them today.",
  faCrewKindAll: "Units & spare",
  faCrewHeld: "Units only",
  faCrewSpare: "Spare",
  faCrewShiftAll: "Any shift",
  faCrewVacantAll: "Crewed & vacant",
  faCrewVacantOnly: "Vacant units only",
  faCrewThOp: "Operator",
  faCrewThRoster: "Roster",
  faCrewThFleet: "Fleet",
  faCrewNoFleet: "No fleet",
  faCrewThUnit: "Unit",
  faCrewThDept: "Department",
  faCrewVacant: "Vacant",
  faCrewOutside: "Outside allocation",
  faCrewOutsideHint:
    "Broken down or in no formation — never allocated and never on a fleet display.",
  faCrewEmpty: "No operator enters allocation yet.",
  faCrewSumB: "rows",
  ...
  faHistBtn: "History",
  faHistTitle: "Standing operator history",
  faHistCurrent: "Current standing operators",
  faHistEmpty: "No standing-operator changes for this unit yet.",
  faHistErr: "History failed to load.",
  faHistAssigned: "Assigned",
  faHistReleased: "Released",
  faHistSrcBoard: "on the board",
  faHistSrcImport: "by import",
  faHistSrcMigration: "already paired when the history began",
  faHistBy: "by",
  udbSerial: "Serial no.",
  ...
  btnClose: "Close",
  navRD: "Roster Data",
  rdSub: "Rosters mirrored from unggul_att, grouped by month. Read-only.",
  rdListTitle: "Rosters by month",
  rdSearchPh: "Search period / department / source…",
  ...
  rdDetailSub:
    "Full contents of the roster — read-only; changes are made in unggul_att.",
  rdDetailFootB: "of 247 employees — read-only data.",
  rdDl: "Download roster file",
  rdDlT: "Roster file downloaded",
  rdFrom: "From date",
  rdTo: "To date",
  rdFromAny: "Start of month",
  rdToAny: "End of month",
  rdToSep: "to",
  rdSumTitle: "Summary",
  rdSumMonth: "whole month",
  rdSumNone: "empty range",
  rdSumScheduled: "Scheduled",
  rdSumDay: "Day shift",
  rdSumNight: "Night shift",
  rdSumAway: "Not working",
  rdSync: "Pull from unggul_att",
  rdSyncT: "Roster synced",
  rdSyncD: "roster cells updated",
  rdSyncErrT: "Roster sync failed",
  ...
  scanLead: "Point the camera at the QR code on the card.",
  scanStart: "Start camera",
  scanStop: "Stop camera",
  scanManual: "Enter NIK",
  scanManualPh: "NIK on the card…",
  scanLookUp: "Look up",
  scanIdle: "No card scanned yet.",
  scanNotFound: "Card not recognised.",
  scanDenied: "Camera permission was refused.",
  scanInsecure: "The camera needs a secure (https) connection.",
  scanNoCamera: "No camera was found on this device.",
  scanMore: "More",
  scanSimper: "Simper Code",
  scanRoster: "Roster",
  scanUnit: "Unit",
  scanArea: "Area",
  scanBus: "Bus",
  scanCheckIn: "Check-in",
  scanShift: "Shift",
  scanAgain: "Scan another card",
