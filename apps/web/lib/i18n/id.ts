...
export const id = {
  ...
  dataAsOf: "Data per",
  statUnfit: "Tidak lolos FTW",
  dUnfit1: "keputusan atau kategori bekerja —",
  dUnfit2: "butuh penggantian",
  statAbsent: "Belum absen",
  dAbsent1: "dari",
  dAbsent2: "yang dijadwalkan shift ini",
  ...
  statPresent: "Hadir shift ini",
  statSimperExp: "SIMPER kedaluwarsa",
  dSimperSoon: "berakhir ≤60 hari",
  statActualShift: "ACTUAL shift ini",
  dNotGenerated: "belum digenerate",
  ...
  chartRatioTitle: "Rasio Operator",
  chartSpareTitle: "Operator Spare",
  chartRestTitle: "Istirahat (kurang tidur)",
  chartEquipmentTitle: "Laporan Alat",
  chartReady: "Siap kerja",
  chartNoFinger: "Belum finger",
  chartNoFtw: "Tidak lolos FTW",
  chartQty: "Jumlah alat",
  chartEqpReady: "Siap",
  chartRunning: "Beroperasi",
  chartCategory: "Kategori",
  chartTotal: "Total",
  chartOperators: "operator",
  chartNoData: "Belum ada data untuk shift ini.",
  statAllocGap: "Unit tidak terisi",
  dUnits: "unit",
  ...
  tlResetT: "Terapkan ulang jadwal ke muster berjalan?",
  tlResetB:
    "Penarikan tap dan pendengaran booth akan mengikuti jam bus terbaru. Tidak ada tahap yang dijalankan ulang.",
  tlResetSafe: "Papan alokasi tidak dibuat ulang.",
  tlResetRunning: "berjalan",
  tlResetDo: "Terapkan ulang",
  tlResetDoing: "Menerapkan…",
  tlResetHint:
  ...
  apTitle: "Prioritas Alokasi",
  apSub: "Urutan unit yang diisi lebih dulu saat operator terbatas.",
  apListTitle: "Urutan prioritas",
  apSave: "Simpan urutan",
  apSaving: "Menyimpan…",
  apSaved: "Urutan prioritas tersimpan.",
  apReset: "Batalkan",
  ...
  apUp: "Naikkan prioritas",
  apDown: "Turunkan prioritas",
  apEmpty: "Belum ada unit aktif",
  apEmptyB:
    "Daftar ini mengikuti unit yang ada di master. Tambahkan unit lebih dulu.",
  ...
  faCrewTitle: "Daftar operator hari ini",
  faCrewSub:
    "Setiap unit dengan operator tetapnya, ditambah operator spare — beserta roster hari ini. Roster per",
  faCrewIdle: "unit tanpa operator hari ini.",
  faCrewKindAll: "Unit & spare",
  faCrewHeld: "Unit saja",
  faCrewSpare: "Spare",
  faCrewShiftAll: "Semua shift",
  faCrewVacantAll: "Terisi & kosong",
  faCrewVacantOnly: "Hanya unit kosong",
  faCrewThOp: "Operator",
  faCrewThRoster: "Roster",
  faCrewThFleet: "Fleet",
  faCrewNoFleet: "No fleet",
  faCrewThUnit: "Unit",
  faCrewThDept: "Departemen",
  faCrewVacant: "Kosong",
  faCrewOutside: "Di luar alokasi",
  faCrewOutsideHint:
    "Unit breakdown atau tidak masuk formasi mana pun — tidak dialokasikan dan tidak muncul di display fleet.",
  faCrewEmpty: "Belum ada operator yang masuk alokasi.",
  faCrewSumB: "baris",
  ...
  faHistBtn: "Riwayat",
  faHistTitle: "Riwayat operator tetap",
  faHistCurrent: "Operator tetap saat ini",
  faHistEmpty: "Belum ada perubahan operator tetap untuk unit ini.",
  faHistErr: "Riwayat gagal dimuat.",
  faHistAssigned: "Dipasang",
  faHistReleased: "Dilepas",
  faHistSrcBoard: "lewat papan",
  faHistSrcImport: "lewat import",
  faHistSrcMigration: "sudah terpasang saat riwayat mulai dicatat",
  faHistBy: "oleh",
  udbSerial: "No. seri",
  ...
  btnClose: "Tutup",
  navRD: "Data Roster",
  rdSub: "Roster dari unggul_att, dikelompokkan per bulan. Hanya-baca.",
  rdListTitle: "Roster per bulan",
  rdSearchPh: "Cari periode / departemen / sumber…",
  ...
  rdDetailSub:
    "Isi lengkap roster — hanya-baca; perubahan dilakukan di unggul_att.",
  rdDetailFootB: "dari 247 karyawan — data hanya-baca.",
  rdDl: "Unduh file roster",
  rdDlT: "File roster diunduh",
  rdFrom: "Dari tanggal",
  rdTo: "Sampai tanggal",
  rdFromAny: "Awal bulan",
  rdToAny: "Akhir bulan",
  rdToSep: "s/d",
  rdSumTitle: "Ringkasan",
  rdSumMonth: "seluruh bulan",
  rdSumNone: "rentang kosong",
  rdSumScheduled: "Terjadwal",
  rdSumDay: "Shift siang",
  rdSumNight: "Shift malam",
  rdSumAway: "Tidak masuk",
  rdSync: "Tarik dari unggul_att",
  rdSyncT: "Roster tersinkron",
  rdSyncD: "sel roster diperbarui",
  rdSyncErrT: "Sinkron roster gagal",
  rdSourceMirror: "unggul_att",
  rdSumA: "Menampilkan",
  ...
  scanTitle: "Scan ID Card",
  scanLead: "Arahkan kamera ke kode QR pada kartu.",
  scanStart: "Nyalakan kamera",
  scanStop: "Matikan kamera",
  scanManual: "Masukkan NIK",
  scanManualPh: "NIK pada kartu…",
  scanLookUp: "Cari",
  scanIdle: "Belum ada kartu yang dipindai.",
  scanNotFound: "Kartu tidak dikenali.",
  scanDenied: "Izin kamera ditolak.",
  scanInsecure: "Kamera memerlukan koneksi aman (https).",
  scanNoCamera: "Tidak ada kamera pada perangkat ini.",
  scanMore: "Lainnya",
  scanSimper: "Kode Simper",
  scanRoster: "Roster",
  scanUnit: "Unit",
  scanArea: "Area",
  scanBus: "Bus",
  scanCheckIn: "Jam masuk",
  scanShift: "Shift",
  scanAgain: "Pindai kartu lain",
