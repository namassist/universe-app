...
export const id = {
  ...
  meRoster: "Roster hari ini",
  meFtw: "Fit To Work",
  meTap: "Finger check-in",
  meUnit: "Unit hari ini",
  meRevision: "Revisi menunggu",
  meNoReading: "Belum ada data",
  meNoTap: "Belum tap",
  meNoUnit: "Belum dapat unit",
  statFleetGap: "Unit belum masuk fleet",
  dFleetGap: "punya operator tetap, tapi di luar semua formasi",
  dNoOperator: "tanpa operator",
  ...
  faFtwPass: "Lolos",
  faFtwFail: "Gagal",
  faFtwLate: "Telat upload",
  faFtwMissing: "Tidak ada data",
  faFtwUnreadable: "Tidak terbaca",
  faFtwNotReq: "Tidak wajib",
  faFingerPassOpt: "Tap tepat waktu",
  faFingerLateOpt: "Tap lewat batas",
  faFingerLate: "lewat batas",
  faAuditTitle: "Rincian perhitungan",
  faAuditNote:
    "Kolom FTW dan finger dibaca dari data terkini — sama dengan yang tampil di menu Fit To Work dan Absensi. Untuk papan yang digenerate sebelum ada data susulan, angkanya bisa berbeda dari yang dilihat engine saat itu.",
  faAuditSearch: "Cari nama, NIK, atau unit…",
  faAuditNoUnit: "NO UNIT",
  faDecKept: "Tetap di unitnya",
  faDecSubstitute: "Menggantikan",
  faDecManual: "Manual",
  faDecNotReady: "Tidak lolos",
  faDecNoSeat: "Tidak kebagian",
  faAuditFleetAll: "Semua fleet",
  faAuditFleet: "Fleet",
  faAuditPlan: "Unit plan",
  faAuditFtwAll: "Semua status FTW",
  faAuditFingerAll: "Semua finger",
  ...
  faAuditOpPlan: "Operator plan",
  faAuditNoTap: "tidak tap",
  ...
  flImpRemoveB:
    "File ini adalah gambaran satu hari penuh, jadi yang tidak disebut dianggap sudah tidak beroperasi. Periksa daftar di bawah sebelum menekan Import.",
  flAdd: "Tambah Fleet",
  flEditT: "Edit Fleet",
  ...
  flErrLeader: "Digger wajib dipilih dan belum memimpin fleet lain.",
